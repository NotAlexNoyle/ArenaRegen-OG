...
public class ListCommand extends ARCommand {
	...
	public void execute(final CommandSender sender, final String label, final String[] args) {
		...
		zones.forEach(zone -> lang.sendMessage(sender, "COMMAND.arenaregen.list.format", "name", zone.getName(), "min_pos", StringUtil.from(zone.getMin()), "max_pos", StringUtil.from(zone.getMax()), "blocks_count", zone.getTotalBlocks()));
